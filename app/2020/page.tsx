...
export default function Festival2020() {
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-lg font-light text-gray-700 leading-relaxed mb-8">
                A year that challenged us to reimagine what a festival could be.
                2020 became a testament to the power of adaptation, community
                resilience, and the unbreakable bonds formed through shared
                creative expression, even in the face of unprecedented global
                changes.
              </p>
              ...
              <div className="space-y-4">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-gray-600 font-light mt-2">
                    Live Streams • Interactive Performances • Global
                    Participation
                  </p>
                </div>
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-gray-600 font-light mt-2">
                    Home Galleries • Neighborhood Art • Community Spaces
                  </p>
                </div>
                <div className="border-b border-gray-200 pb-4">
                  <h4 className="text-xl font-light text-black">
                  ...
                  <p className="text-gray-600 font-light mt-2">
                    Online Collaboration • Remote Creation • Skill Sharing
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 font-light leading-relaxed">
                    Technology bridged physical distances, creating intimate
                    connections across continents through shared musical
                    experiences.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-600 font-light leading-relaxed">
                    A support system emerged, connecting festival family members
                    for mutual aid and creative collaboration.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-light text-black mb-2">
                  ...
                  <p className="text-gray-600 font-light leading-relaxed">
                    Lessons learned in adaptation and resilience became the
                    blueprint for future festival innovations.
                  </p>
                </div>
              </div>
            </div>
